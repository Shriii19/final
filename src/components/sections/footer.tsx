                    ...
                    <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-4 xl:mt-0 md:grid-cols-4">
                        <div>
                            ...
                            <ul className="mt-4 space-y-4">
                                <li><a href="https://panel.valtoria.cloud/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-white transition-colors">Game Panel</a></li>
                                <li><a href="https://store.valtoria.cloud/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-white transition-colors">Billing Panel</a></li>
                                <li><a href="https://status.valtoria.cloud/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-white transition-colors">Network Status</a></li>
                                <li><a href="https://www.trustpilot.com/review/valtoria.cloud/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-white transition-colors">Trustpilot</a></li>
                                <li><Link href="/partners" className="text-sm text-gray-400 hover:text-white transition-colors">Partner with us</Link></li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="mt-4 space-y-4">
                                <li className="flex items-center">
                                    ...
                                    <a href="mailto:help@voltria.cloud" className="text-sm text-gray-400 hover:text-white transition-colors">help@voltria.cloud</a>
                                </li>
                                <li className="flex items-center">
                                    <MessageSquare className="h-5 w-5 mr-3 flex-shrink-0 text-blue-500" />
                                    <a href="https://discord.gg/3KdcAhfuq4" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-white transition-colors">Discord</a>
                                </li>
                            </ul>
                        </div>
                    </div>
